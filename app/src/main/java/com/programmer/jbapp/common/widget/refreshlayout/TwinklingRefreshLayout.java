package com.programmer.jbapp.common.widget.refreshlayout;
...
import com.programmer.jbapp.common.widget.refreshlayout.Footer.BallPulseView;
import com.programmer.jbapp.common.widget.refreshlayout.header.GoogleDotView;
import com.programmer.jbapp.common.widget.refreshlayout.processor.AnimProcessor;
import com.programmer.jbapp.common.widget.refreshlayout.processor.IDecorator;
import com.programmer.jbapp.common.widget.refreshlayout.processor.OverScrollDecorator;
import com.programmer.jbapp.common.widget.refreshlayout.processor.RefreshProcessor;
import com.programmer.jbapp.common.widget.refreshlayout.utils.DensityUtil;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
    ...
    private int mTouchSlop;     //手势滑动的距离
    ...
    private void addHeader() {
        ...
        if (mHeadView == null) setHeaderView(new GoogleDotView(getContext()));  //默认刷新头部
    }
    ...
    private VelocityTracker moveTracker;       //求瞬时速度的类
     ...
     * 触摸事件处理
     *****************************************/
    int mMaxVelocity = ViewConfiguration.get(getContext()).getScaledMaximumFlingVelocity();  //最大的速率
