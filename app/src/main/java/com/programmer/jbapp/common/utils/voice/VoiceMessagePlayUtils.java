package com.programmer.jbapp.common.utils.voice;

import android.content.Context;
import android.media.AudioManager;
import android.media.MediaPlayer;

import com.lib.base.common.FCError;
import com.lib.base.log.KLog;
import com.lib.base.utils.StringUtil;
import com.programmer.jbapp.R;
import com.programmer.jbapp.application.JBApplication;
import com.programmer.jbapp.common.sp.SpSetting;
...
//            mPresenter.closeVoicePlayInCallWarning();
    ...
    private void playEndSound(final boolean isHandFree, final VoiceMessagePlayListener listener)
    {
        ...
        {
            mMediaPlayer.reset();
            mMediaPlayer = MediaPlayer.create(JBApplication.getInstance(), R.raw.play_end);
            mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener()
            {
                @Override
                public void onCompletion(MediaPlayer mp)
