package com.programmer.jbapp.module.technique.adapter;
 ...
 * 2016/11/22.
 */
public class TechniqueListAdapter extends BaseAdapter {
    private Context mContext;
    private List<Technique> mList = new ArrayList<Technique>();

    public TechniqueListAdapter(Context mContext, List<Technique> mList) {
